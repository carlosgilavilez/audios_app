                       ...
                       @foreach ($series as $serie)
                            <tr id="serie-row-{{ $serie->id }}" class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-3 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="{{ route(auth()->user()->role . '.series.edit', ['serie' => $serie->id]) }}" class="inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-blue-400 text-white hover:bg-blue-500 h-7 w-7" title="Editar">
