<div class="inline-flex items-center gap-2">
    ...
    <select id="per-page" name="per_page"
        class="block w-auto rounded-md border-border bg-transparent py-1.5 pl-3 pr-8 text-sm font-medium text-foreground transition hover:bg-muted focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
